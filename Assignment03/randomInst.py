...
class RandInstructions:
    def __init__(self, **kwargs):
        ...
        self.type = kwargs.get("type", "writer") # or reader
...
if __name__ == "__main__":
    for i in range(25):
      ri = RandInstructions(privileged=0.3,type="reader",outFile=f"reader_{i}.exe")
  
    # ri = RandInstructions(privileged=0.3,type="writer",outFile="writer_4.exe")
